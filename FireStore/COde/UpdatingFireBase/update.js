...
import { collection, setDoc ,getDocs,addDoc,getFirestore,doc, deleteDoc,updateDoc}from "https://www.gstatic.com/firebasejs/9.14.0/firebase-firestore.js";
...
document.getElementById('updated').addEventListener('click',async function(e){
    let name_id = document.getElementById('OldName').value;
    e.preventDefault();
    await updateDoc(doc(db, "cafes", Map_Doc.get(name_id)),data());
